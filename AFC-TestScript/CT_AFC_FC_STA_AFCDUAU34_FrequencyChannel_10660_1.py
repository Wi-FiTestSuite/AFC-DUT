...
class CT_AFC_FC_STA_AFCDUAU34_FrequencyChannel_10660_1(AFCBaseScript):
    def __init__(self):
    ...
    def execute(self):
        ...
        AFCLib.set_afc_response("UAU", test_vector=3, phase=1)
        ...
        AFCLib.set_afc_response("UAU", test_vector=3, phase=2)
