...
class CT_AFC_FC_STA_AFCDRSA31_Channel_160MHz_10650_1(AFCBaseScript):
    ...
    def execute(self):
        ...
        AFCLib.set_afc_response("RSA", test_vector=2, only_random_power=True)
        ...
        power_valid = super().validate_rf_measurement_by_chan(afc_resp["sentResponse"], op_channel, "rfMeasurementReport_step_14.json", op_bandwidth=160)
