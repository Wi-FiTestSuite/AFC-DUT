...
class CT_AFC_FC_STA_AFCDRSA31_Frequency_160MHz_10643_1(AFCBaseScript):
    ...
    def execute(self):
        ...
        AFCLib.set_afc_response("RSA", test_vector=1, only_random_power=True)
        ...
        power_valid, adjacent_valid = super().validate_rf_measurement_by_freq(afc_resp["sentResponse"], op_channel, "rfMeasurementReport_step_14.json", op_bandwidth=160)
