...
class CT_AFC_FC_STA_AFCDUAU34_Frequency_10646_1(AFCBaseScript):
    def __init__(self):
    ...
    def execute(self):
        ...
        AFCLib.set_afc_response("UAU", test_vector=1, phase=1)
        ...
        AFCLib.set_afc_response("UAU", test_vector=1, phase=2)
